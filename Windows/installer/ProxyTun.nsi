!define PRODUCT_NAME "ProxyTun"
!define PRODUCT_VERSION "3.2.0"
!define PRODUCT_PUBLISHER "ProxyTun"
!define PRODUCT_WEB_SITE "https://github.com/ProxyTun/ProxyTun"
...
OutFile "ProxyTun-Setup-${PRODUCT_VERSION}.exe"
...
Section "MainSection" SEC01
  ...
  File "..\output\ProxyTun.exe"
  File "..\output\ProxyTun_CLI.exe"
  File "..\output\ProxyTunCore.dll"
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\${PRODUCT_NAME}.lnk" "$INSTDIR\ProxyTun.exe"
  CreateShortCut "$DESKTOP\${PRODUCT_NAME}.lnk" "$INSTDIR\ProxyTun.exe"
...
Section -Post
  ...
  WriteRegStr HKLM "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\ProxyTun.exe"
...
Section Uninstall
  Delete "$INSTDIR\ProxyTun.exe"
  Delete "$INSTDIR\ProxyTun_CLI.exe"
  Delete "$INSTDIR\ProxyTunCore.dll"
